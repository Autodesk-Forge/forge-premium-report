                    ...
                    if (exceljson.length > 0 && cnt == 2) {
                        ...
                        fetch("metadata.json")
                            ...
                            .then(json => {
                                ...
                                for (var i in exceljson) {
                                    var obj = {
                                        email: exceljson[i].email, product_name: exceljson[i].product_name, team_alias: exceljson[i].team_alias,
                                ...
                                for (var j in metadata1) {
                                    if (typeof obj_m_version[metadata1[j].email] == 'undefined') {
                                        product_version.push({
                                            email: metadata1[j].email, product_name: metadata1[j].product_name, team_alias: metadata1[j].team_alias,
